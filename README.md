...
O [P7](docs/p7-production-governance.md) adiciona OPA fail-closed, OIDC, evidências S3, SBOM/assinatura, OTLP, budgets, filas/workers, sandbox, Change Set e recuperação orientada por SLO.
